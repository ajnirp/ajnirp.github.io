...
If you find this sort of invariant-based analysis interesting, consider reading up on [Program Derivation](https://en.wikipedia.org/wiki/Program_derivation), in particular the book [Programming: The Derivation of Algorithms by Anne Kaldewaij](https://www.google.com/books/edition/_/4nJqQgAACAAJ?hl=en). A powerful idea in program derivation is that you can write a program by methodically translating invariants into pseudocode. This is nice because it's typically much easier to formulate invariants for a given problem statement than to directly write a bug-free program.